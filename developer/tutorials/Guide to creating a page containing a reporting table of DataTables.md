...
* [nopCommerce architecture](xref:https://docs.nopcommerce.com/developer/tutorials/source-code-organization.html)
* [nopCommerce Plugin](xref:https://docs.nopcommerce.com/developer/plugins/how-to-write-plugin_4.20.html)
* [Entity Framework Core](xref:https://docs.microsoft.com/en-us/ef/core)
* [nopCommerce routing](xref:https://docs.nopcommerce.com/developer/tutorials/register-new-routes.html).
...
I am assuming that you already know where and how to create nopCommerce plugin project and configure the project according to nopCommerce standard. If you don’t know then you can see
[How to write a plugin for nopCommerce](xref:https://docs.nopcommerce.com/developer/plugins/how-to-write-plugin_4.20.html) to know how to create and configure nopCommerce plugin project.
...
First let’s create a model named `CustomersDistrubution` inside Models directory.

## Step 2: Create Models

### CustomersDistrubution.cs
...
### CustomersByCountryController.cs
...
To learn more about nopCommerce routing please visit [Register new routes](xref:https://docs.nopcommerce.com/developer/tutorials/register-new-routes.html)
