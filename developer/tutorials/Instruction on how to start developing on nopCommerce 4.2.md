...
### 1.1. [\.NET Core 2.2 runtime & .NET Core SDK](xref:https://dotnet.microsoft.com/download/dotnet-core/2.2)
...
### 1.2. [Visual Studio 2017 or Above](xref:https://visualstudio.microsoft.com/) / [Visual Studio Code](xref:https://code.visualstudio.com)
...
### 1.3. [Microsoft SQL Server 2012 or Above](xref:https://www.microsoft.com/en-us/sql-server/sql-server-downloads)
...
### 1.4. [Internet Information Service (IIS) 7.0 or above](xref:https://www.howtogeek.com/112455/how-to-install-iis-8-on-windows-8/)
